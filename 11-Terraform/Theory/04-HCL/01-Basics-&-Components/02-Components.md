...
| **Resource Identifier**  | **Name** or **Type** of the resource                                            | `resource "local_file" "tea"`   |
| **Parameter / Argument** | Key-value pairs inside a block                                                  | Key-value config inside a block | `region = "us-west-1"`                                                            |
